export const c = {
    ...
    STATE_WARNING: 4, 
    STATE_LOADING: 8,
    MASK_STATUS: 7, // STATE_SUCCESS | STATE_ERROR | STATE_WARNING
    ...
    LSTATE_SELECTED: 2,
    LSTATE_REFRESH: 4,
    MASK_SELECTED_REFRESH: 6, // LSTATE_SELECTED | LSTATE_REFRESH
    ...
    STATE_LOAD_OLDER: 64,
    STATE_RELOAD: 128,
    MASK_RPC: 224, // STATE_LOAD_NEWER | STATE_LOAD_OLDER | STATE_RELOAD
    
    STATE_LOCAL_SEARCH: 256,
    MASK_RPC_DISABLE: 264, // STATE_LOADING | STATE_LOCAL_SEARCH
