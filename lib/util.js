...
export function tableUp(pager, col_size, flags, idx, e, toAdd) {
    e.preventDefault();
    var index_hidden;
    if (idx === -1) {
...
export function tableJumpUp(pager, col_size, flags, idx, e, toAdd) {
    e.preventDefault();
    if (idx === -1) {
...
export function tableDown(pager, col_size, flags, idx, e, toAdd) {
    e.preventDefault();
    if (idx === -1) {
...
export function tableJumpDown(pager, col_size, flags, idx, e, toAdd) {
    e.preventDefault();
...
export function tableLeft(pager, col_size, flags, idx, e, toAdd) {
    e.preventDefault();
    if (idx === -1) {
        pager.$handle(8 + toAdd, Math.min(col_size - 1, pager.index_hidden - 1));
    }
...
export function tableJumpLeft(pager, col_size, flags, idx, e, toAdd) {
    e.preventDefault();
    if (idx === -1) {
        pager.$handle(8 + toAdd, 0);
    }
...
export function tableRight(pager, col_size, flags, idx, e, toAdd) {
    e.preventDefault();
    if (idx === -1) {
...
export function tableJumpRight(pager, col_size, flags, idx, e, toAdd) {
    e.preventDefault();
    if (idx === -1) {
        pager.$handle(8 + toAdd, Math.min(col_size - 1, pager.index_hidden - 1));
    }
