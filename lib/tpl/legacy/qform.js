...
export function field_enum(fd, pojo, display) {
...
export function field_bool(fd, pojo, display) {
...
export function field_default(fd, pojo, display, changeSuffix) {
