import { when, when_fn, append, prepend, include_if, quote } from '../common';
...
function dpicker(it, fd, pojo) {
    return " v-dpicker:" + (it.update ? 16 /* UPDATE */ : 0) + "=\"{ pojo: " + pojo + ", field: '" + (fd.$ || fd._) + "' }\"";
}
function field_num(it, fd, idx, pojo, ffid) {
