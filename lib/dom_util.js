...
isIE9 = UA && UA.indexOf('msie 9.0') > 0, createEvent = document['createEvent'], createEventObject = document['createEventObject'], 
...
function bFocus() {
    var el = this.el !== undefined ? this.el : (this.el = document.getElementById(this.id));
    if (el)
        el.focus();
}
