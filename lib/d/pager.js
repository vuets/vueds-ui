...
import { selectIdx, pageAndSelectIdx, listUp, listDown, tableUp, tableDown, tableLeft, tableRight, tableJumpUp, tableJumpDown, tableJumpLeft, tableJumpRight } from '../pager_util';
...
function moveDown(e) {
    ...
    if (current.col_size)
        ...
        listDown(pager, pager.index_selected, e, toAdd);
}
